...
const exitStudyList = async (setResourcesArray : React.Dispatch<React.SetStateAction<IResourceArray[]>> , setShowingStudyList : React.Dispatch<React.SetStateAction<boolean>>) : Promise<void> => {
